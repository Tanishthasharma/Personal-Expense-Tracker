...
export const transactions = <i className="fa-solid fa-money-bill-transfer"></i>;
...
export const expenses = <i className="fa-solid fa-wallet"></i>;

export const money = <i className="fa-solid fa-sack-dollar"></i>;
export const freelance = <i className="fa-solid fa-briefcase"></i>;
export const stocks = <i className="fa-solid fa-chart-simple"></i>;
